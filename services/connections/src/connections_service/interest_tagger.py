...
TAG_SYSTEM = (
    ...
    "- Tag ONLY interests the person actually describes. Paraphrase is expected — map their own "
    "words to the closest node even if the exact term isn't used (e.g. 'scrambling up rock "
    "faces' -> outdoor_active:rock_climbing; a named band/artist -> its genre). But NEVER ADD a "
    "related, adjacent, or assumed interest they did not mention themselves (e.g. do not infer "
    "photography from hiking, or cooking from 'likes food'). If in doubt, leave it out.\n"
